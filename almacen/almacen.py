...
def verificar_api_key():
    # Todo request al API debe venir acompañado de un API Key válido
    # bajo el header 'api-key'
    api_key = request.headers.get('api-key')
    api_key_es_valida = servicio_consumidores.validar_api_key(
        api_key, api_key_consumidor_admin) if api_key is not None else False
